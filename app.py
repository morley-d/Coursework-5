...
def choose_hero():
    ...
    if request.method == 'POST':
        ...
        choosen_unit_class = request.form['unit_class']
        weapon_name = request.form['weapon']
        armor_name = request.form['armor']
        new_player = PlayerUnit(name=name, unit_class=unit_classes[choosen_unit_class])
...
def choose_enemy():
    ...
    if request.method == 'POST':
        ...
        weapon_name = request.form['weapon']
        armor_name = request.form['armor']
        new_enemy = EnemyUnit(name=name, unit_class=unit_classes[choosen_unit_class])
